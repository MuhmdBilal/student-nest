...
function UpdateSingleAgencyData() {
    ...
    const UpdateData = async () => {
        try {
            setLoading(true)
            await axios.put(`${BACKEND_URI}/update_single_person_agency_data/${params.id}`, {
                active,
                title,
                description,
                currentTime,
                ...
                setLoading(false)
                toast.success("Agencies Updated successfully")
...
export default UpdateSingleAgencyData