...
function UpdateSingleSubjectData() {
    ...
    const UpdateData = async () => {
        try {
            await axios.put(`${BACKEND_URI}/update_single_person_subjects_data/${params.id}`, {
                active,
                title,
                description,
                currentTime,
        ...
        <div className='container'>
            <div className='row user-box-1'>
                <div className='col-lg-12 col-12  d-flex justify-content-center  justify-content-between align-items-center pt-3 pb-3'>
                    <h4 className='user-h4 mt-2'>Update Subject</h4>
                </div>
            </div>
...
export default UpdateSingleSubjectData